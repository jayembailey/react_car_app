                ...
                <div className='w-full block flex-grow items-center'>
                    <div className="text-sm lg:flex-grow">
                        ...
                        </Button>
                        {
                            ...
                            <Button className='p-3 m-5 bg-teal-400 justify-center rounded-lg'>
                                <div>
                                    <Link to='/' onClick={ () => {signInOnClick()}} className="flex place-content-center mt-4 lg:inline-block lg:mt-0 text-red-800 hover:text-white">
                                        Login
                                    </Link>
                                </div>
                            </Button>
                            ...
                            <Button className='p-3 m-5 bg-teal-400 justify-center rounded-lg'>
                                <div>
                                    <Link to='/' onClick={ () => {signOutOnClick()}} className="flex place-content-center mt-4 lg:inline-block lg:mt-0 text-red-800 hover:text-white">
                                        Logout
                                    </Link>
                                </div>
                            </Button>
